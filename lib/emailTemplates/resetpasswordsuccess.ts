export function passwordResetSuccessTemplate(userName: string) {
  return `<!DOCTYPE html>
<html lang="en">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" 
        ...
        <tr>
          <td align="center" 
            ...
            <p style="font-size:14px; margin:6px 0 0 0; opacity:0.9;">Account Update</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:40px 40px 20px 40px; text-align:left;">
            ...
            <p style="color:#4b5563; font-size:17px; line-height:1.7; margin:0 0 24px;">
              ...
              Your <b>Upcoder</b> account password has been successfully reset.  
