  ...
  const faqs = [
    {
      ...
      answer:
        "We currently offer beginner-friendly coding courses starting at just ₹29. Topics include web development, data basics, and more.",
    },
    {
      question: "Do I need prior experience?",
      answer: "No prior programming experience is required. Our courses are designed for complete beginners.",
    },
    {
      question: "How can I get started?",
      answer: "Simply fill out the contact form, and our team will guide you on enrolling in the courses of your choice.",
    },
    {
      question: "Are there any hidden fees?",
      answer: "No. All courses start from ₹29 and the pricing is transparent.",
    },
    {
      question: "Can I ask questions during the course?",
      answer: "Yes! You can reach out via email or our community chat for any support.",
    },
  ]
    ...
    <section className="py-20 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Start Learning with <span className="text-gradient">Upcoder Today!</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Explore our low-cost courses starting from just ₹29. Have questions? Fill the form below, and we'll help you get started.
          </p>
        </div>
            ...
            <Card className="shadow-lg">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium">Email</div>
                    <div className="text-sm text-muted-foreground">support@upcoders.vercel.app</div>
                  </div>
                </div>
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold mb-4">Frequently Asked Questions</h3>
            <p className="text-muted-foreground">Answers to common questions about our low-cost courses</p>
          </div>
